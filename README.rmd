...
Course materials for the *Hands-on Machine Learning in R* course (November 2021).

`r emo::ji("calendar")` Module 1 on November 8 & 10, 2021, Module 2 on November 15 & 17, 2021 and Module 3 on November 22 & 24, 2021
<br>
`r emo::ji("clock")` From 9.00 am to 12.00 pm 
<br>
...
<p align="justify"> *Roel Henckaerts* holds the degrees of
...
strategic basic research). After the completion of his PhD, Roel joined [Prophecy Labs](https://prophecylabs.com/): an AI/ML startup with experience in building end-to-end data solutions that provide concrete business value.</p>
