...
The schedule will gradually be completed over the next weeks. The detailed schedule is subject to small changes. 
...
use your local installation of R and RStudio. The first option is very easy and accessible. Make sure one of these options works smoothly before coming to the workshop. A technical test session will be organized to get you started in case of problems or doubts.
...
- you should now be able to visit the 'Module 1' project and see the 'scripts' and 'data' folders on the right. Open and run the 'installation-instructions.R' script from the scripts folder, to see if everything works fine.
